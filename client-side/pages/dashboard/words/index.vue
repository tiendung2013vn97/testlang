<template>
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Danh sách dịch từng từ</h4>
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div class="d-flex">
                        <nuxt-link class="btn btn-success mr-2" :to="{ name: 'dashboard-words-create' }" style="width: 40%">Tạo mới</nuxt-link>
...
export default {
    ...
    created() {
        this.$store.commit('setActiveSidebar', { isActive: 'translate', subIsActive: 'words-list' });
        this.initUrl();
    },
    methods: {
        editItem: function(id){
            this.$router.push({ name: 'dashboard-words-update-id', params: { id: id }, query: { return: this.$route.query.page } });
        },
        deleteItem: function(id){
            this.$http.post('translate/delete/' + id + '?type=word')
            .then( response => {
        ...
        initUrl: function(){
            if(this.globalObjectLength(this.$route.query)){
                ...
                this.apiUrl = '/translate/list-words';
            }
        },
