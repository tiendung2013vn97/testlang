...
export default {
    ...
    created() {
        this.$store.commit('setActiveSidebar', { isActive: 'langs', subIsActive: 'lang-list' });
        this.initUrl();
    },
    methods: {
        editItem: function(id){
            this.$router.push({ name: 'dashboard-lang-update-id', params: { id: id }, query: { return: this.$route.query.page } });
        },
        deleteItem: function(id){
            this.$http.post('langs/delete/' + id)
            .then( response => {
