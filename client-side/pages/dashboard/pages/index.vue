...
export default {
    ...
    created() {
        this.$store.commit('setActiveSidebar', { isActive: 'pages', subIsActive: 'page-list' });
        this.initUrl();
    },
    methods: {
        editItem: function(id){
            this.$router.push({ name: 'dashboard-pages-update-id', params: { id: id }, query: { return: this.$route.query.page } });
        },
        deleteItem: function(id){
            this.$http.post('pages/delete/' + id)
            .then( response => {
