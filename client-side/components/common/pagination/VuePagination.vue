<template>
  <div class="mt-5 paginate-position" v-if="tablePagination">
    <div v-show="tablePagination && tablePagination.last_page > 1" :class="css.wrapperClass" class="pagination">
      <a @click="loadPage(1)"
...
<script>
import PaginationMixin from './VuePaginationMixin.vue'
export default {
