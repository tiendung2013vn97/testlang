<template>
    ...
    <div class="navbar navbar-expand-md navbar-dark bg-indigo navbar-static">
        <div class="navbar-brand">
            <nuxt-link :to="{ name: 'index' }" class="d-inline-block">
                <img src="/dashboard-asset/global_assets/images/logo_light.png">
            </nuxt-link>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbar-mobile">
            <span class="navbar-text ml-md-3">
                ...
                Chào, {{ $store.state.user.data.username }}!
            </span>
            ...
            <ul class="navbar-nav ml-md-auto">
                        ...
                        <div class="dropdown-content-body p-2">
                            <div class="row no-gutters">
                                <div class="col-12 col-sm-4">
                                    <a href="#" class="d-block text-default text-center ripple-dark rounded p-3 legitRipple">
                ...
                <li class="nav-item">
                    <a href="#" class="navbar-nav-link legitRipple" @click="logOut()">
