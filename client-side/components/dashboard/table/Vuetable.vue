                    ...
                    <template v-if="isSpecialField(field.name)">
                      ...
                      >
                        <template v-for="(action, index) in itemActions">
                            <button type="button" :title="action.titleName" @click="clickActions(item, action, field.param, action)" :class="action.class" :key="index"><i :class="action.icon" style="font-size: 20px; padding: 0 auto"></i></button>
                        </template>
                      </td>
                      ...
                      <td v-if="extractName(field.name) == '__list'"
                        :key="fieldIndex"
                      > 
                        {{ globalRenderListData(item, field.listName, field.dataName) }}
                      </td>
